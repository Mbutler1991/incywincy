...
ROOT_URLCONF = 'incywincybackend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'incywincywebservices', 'dist')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'incywincybackend.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'incywincywebservices', 'dist'),  # Vite's output folder
]
