...
const HeroSection = () => {
    return (
        <section className="flex flex-col items-center justify-center h-screen bg-gradient-to-l from-white via-silver to-gray text-white text-center px-4">
            <h2 className="text-5xl font-bold mb-4 text-darkPurple max-w-xl mx-auto">Welcome to Incy Wincy Web Services</h2>
            <h3 className="text-xl mb-8 max-w-lg mx-auto">We create amazing web experiences</h3>
